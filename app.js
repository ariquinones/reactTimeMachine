...
function app() {
  ...
  var AppView = _react2.default.createClass({
    ...
    _subtractYear: function _subtractYear() {
      if (this.state.ticking === false) {
        var toThePast = function toThePast() {
          this.setState({
            ticking: true,
    ...
    _addYear: function _addYear() {
      if (this.state.ticking === false) {
        var toTheFuture = function toTheFuture() {
          this.setState({
            ticking: true,
            currentYear: this.state.currentYear + 1,
    ...
    render: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "button",
          { onClick: this._subtractYear },
          this.state.pastButton
        ),
        _react2.default.createElement(
          "button",
          { onClick: this._addYear },
          this.state.futureButton
        )
      );
    }
  });
